...
A documentação detalhada de funcionamento, banco de dados, regras de negócio, configuração e manutenção fica na **Wiki do projeto**.

[Consultar a Wiki](https://github.com/camila-ubt/calculo-pa/wiki)
