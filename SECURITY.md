...
A versão publicada mais recente do Cálculo PA recebe correções de segurança.
...
O cliente web utiliza somente a URL pública do projeto e uma chave **publishable** do Supabase. A autorização dos dados é aplicada no banco com Row Level Security (RLS).
